...
export const serviceFormSchema = z.object({
  ...
  short_description_ar: z.string().min(1, "الوصف القصير بالعربي مطلوب").max(200, "الحد الأقصى 200 حرف"),
  short_description_en: z.string().min(1, "الوصف القصير بالانجليزي مطلوب").max(200, "الحد الأقصى 200 حرف"),
  ...
  features: z.array(
    z.object({
      ...
      description_ar: z.string().min(1, "الوصف بالعربي مطلوب").max(200, "الحد الأقصى 200 حرف"),
      description_en: z.string().min(1, "الوصف بالانجليزي مطلوب").max(200, "الحد الأقصى 200 حرف"),
      image: z.any().optional().nullable(),
      published: z.boolean(),
    })
  ),
