		...
		return (
			<>
				...
				<Popover
					...
					<PopoverTrigger className="px-0!" asChild>
						<Button
							ref={buttonRef}
							{...props}
							...
							{selectedValues.length > 0 ? (
								<div className="flex justify-between shadow-xs border py-1 ps-4 items-center w-full">
									<div
										className={cn(
								...
								<div className="flex items-center py-2 shadow-sm border px-4 justify-between w-full mx-auto">
					...
					<PopoverContent
						...
						<Command>
							...
							<CommandList
								...
								<CommandEmpty>
									{emptyIndicator || "لا يوجد نتائج بحث"}
								</CommandEmpty>{" "}
								{!hideSelectAll && !searchValue && (
									<CommandGroup>
										<CommandItem
											...
											<div
												className={cn(
													"mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-main",
													selectedValues.length ===
											...
											{group.options.map((option) => {
												...
												return (
													<CommandItem
														...
														{option.icon && (
															<option.icon
																className="mr-2 h-4 w-4 text-muted-foreground bg-main!"
																aria-hidden="true"
															/>
														)}
